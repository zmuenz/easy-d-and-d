    ...
    return (
        <div id='parallax1' className="parallax-container" style={{ height: '500px' }}>
            ...
            <div id="landingCards" style={{ display: 'flex', alignItems: 'space-around', flexFlow: 'row wrap' }}>
                <div id='card2-1' className="card col-sm-3 col-md-3 text-center text-light grow">
                ...
                <div id='card2-2' className="card col-sm-3 col-md-3 text-center text-light grow">
                ...
                <div id='card2-3' className="card col-sm-3 col-md-3 text-center text-light grow">
