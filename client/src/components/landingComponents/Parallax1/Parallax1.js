    ...
    return (
        <div id='parallax1' className="parallax-container" style={{ height: '500px' }}>
            ...
            <div id="landingCards" style={{ display: 'flex', alignItems: 'space-around', flexFlow: 'row wrap' }}>
                <div id='card1' className="card col-sm-3 col-md-3 text-center text-light grow">
                ...
                <div id='card2' className="card col-sm-3 col-md-3 text-center text-light grow">
                ...
                <div id='card3' className="card col-sm-3 col-md-3 text-center text-light grow">
            ...
            <a href='/newcharacter'><button id='build1' className='btn btn-bg-dark btn-large btn-outline-light grow'>Start Building!</button></a>
        </div>
    );
}
